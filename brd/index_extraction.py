...
wrong_headings = ['My','Collections','Brgggn, A. Wind between the', 'Underngian. F. B. On a passing', 'Richardson, H: H. Fortunes of',
...
suffix = ['32106019850368','32106019610374','32106019610382','32106019610390','32106019610408','32106019610416','32106019610424','32106019610432','32106019610440','32106019610457','39015078261180','32106019610465','32106019610473','32106019610481']
                    ...
                    if len(text[j + k]) > 1 and len(text[k + j]) <= 30 and '(' not in text[
                        ...
                        if (text[k + j][0] >= 'A' and text[k + j][0] <= 'Z' and text[k + j][1] >= 'a' and
                            ...
                            if (text[k + j] in subheadings or text[
                                k + j] in wrong_headings or text[k+j][0:13]=='United States' or text[k+j][0:6]=='France'):  # For wrong headings, ignore them
                                continue

...
year = ['1921','1922','1923','1924','1925','1926','1927','1928','1929','1930','1931','1932','1933','1934','1935','1936','1937']
suffix = ['32106019850368','32106019610374','32106019610382','32106019610390','32106019610408','32106019610416','32106019610424','32106019610432','32106019610440','32106019610457','39015078261180','32106019610465','32106019610473','32106019610481','32106019610499','39015078261230','32106019610507']
                    ...
                    if len(text[j + k]) > 1 and len(text[k + j]) <= 30 and '(' not in text[
                        ...
                        if (text[k + j][0] >= 'A' and text[k + j][0] <= 'Z' and text[k + j][1] >= 'a' and
                            ...
                            if len(text[j + k]) >= 9:  # not "xxx-Continued"
                                if (text[j + k][-9:] in ['Continued', 'Continucd','Uontinued','Continual']):
                                    continue
                            if (text[k + j] in subheadings or text[
                                k + j] in wrong_headings or text[k+j][0:13]=='United States' or text[k+j][0:13]=='United State*' or text[k+j][0:6]=='France' or text[k+j][0:13]=='Great Britain' or text[k+j][0:13]=='Qreat Britain' or text[k+j][0:7]=='Germany' or text[k+j][0:7]=='Austria' or (text[k+j][0:11]=='Inquisition' and text[k+j][12:17]=='Spain')):  # For wrong headings, ignore them
                                continue
            ...
            if (text[j] == "Fiction (classified by subject)" or text[j]=='Fiction (classified according to subject)'):
                ...
                if (length > 0):
                    for k in list(range(length)):
                        ...
                        count = -1
                        for m in list(range(len(fiction_books[k]))):
                            if(fiction_headings[k]=='Young people' or fiction_headings[k]=='Field, Eugene' or fiction_headings[k]=='Zionism'):

                    ...
                    if len(text[j + k]) > 1 and len(text[k + j]) <= 30 and '(' not in text[
                        ...
                        if (text[k + j][0] >= 'A' and text[k + j][0] <= 'Z' and text[k + j][1] >= 'a' and
                            ...
                            if (text[k + j] in subheadings or text[
                                k + j] in wrong_headings or text[k+j][0:13]=='United States' or text[k+j][0:13]=='United State*' or text[k+j][0:6]=='France' or text[k+j][0:6]=='Russia' or text[k+j][0:13]=='Great Britain' or text[k+j][0:13]=='Qreat Britain' or text[k+j][0:7]=='Germany' or text[k+j][0:7]=='Austria' or (text[k+j][0:11]=='Inquisition' and text[k+j][12:17]=='Spain') or text[k+j][0:11]=='Set Fiction'):  # For wrong headings, ignore them
                                continue

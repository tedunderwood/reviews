                ...
                for k in list(range(1, linelength - j)):
                    ...
                    if ((volume1976_and_later==0 and len(text[j + k]) > 1 and len(text[k + j]) <= 30 and '(' not in text[
                        ...
                        if (text[k + j][0] >= 'A' and text[k + j][0] <= 'Z' and text[k + j][1] >= 'a' and
                                ...
                                k + j] not in wrong_headings and text [k+j][-11:]!='Collections' and text[k+j][0:13]!='United States' and text[k+j][0:13]!='United State*' and text[k+j][0:13]!='United Btates' and text[k+j][0:13]!='United Slutcs' and text[k+j][0:12]!='United 8tate' and text[k+j][-13:]!='United States' and text[k+j][0:6]!='France' and text[k+j][0:6]!='Russia' and text[k+j][0:7]!='America' and text[k+j][0:7]!='England' and text[k+j][0:7]!='Britain' and text[k+j][0:13]!='Great Britain' and text[k+j][0:13]!='Qreat Britain' and text[k+j][0:7]!='Germany' and text[k+j][0:7]!='Austria' and (text[k+j][0:6]!='States' and text[k+j][-18:]!='Nineteenth century') and (text[k+j][0:11]!='Inquisition' and text[k+j][12:17]!='Spain') and text[k+j][0:11]!='Set Fiction' and text[k+j][0:11]!='Bee Fiction' and (text[k+j][0:7]!='Fiction' and text[k+j][8:17]!='Ciintinui') and (text[k+j][0:3]!='Pru' and text[k+j][5:7]!='io' and (text[k+j][0:7]!='Fiction' and text[k+j][8:13]!='Youth') and (text[k+j][0:7]!='Fiction' and text[k+j][8:22]!='Mental illness') and (text[k+j][0:7]!='Fiction' and text[k+j][8:27]!='United States. Navy') and (text[k+j][0:7]!='Fiction' and text[k+j][8:21]!='Race problems') and (text[k+j][0:7]!='Fiction' and text[k+j][8:21]!='Psychiatrists') and (text[k+j][0:7]!='Fiction' and text[k+j][8:16]!='Surgeons') and (text[k+j][0:7]!='Fiction' and text[k+j][8:17]!='Espionage') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Chicago. University') and (text[k+j][0:7]!='Fiction' and text[k+j][10:]!='Oxiord. University') and (text[k+j][0:7]!='Fiction' and text[k+j][10:]!='School life') and (text[k+j][0:7]!='Fiction' and text[k+j][10:]!='Vassar College') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='College life') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Catholic priests') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Poets') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Teachers') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Spies')  and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Navaho Indians') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='International intrigue') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Poker') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Espionage') and (text[k+j][0:11]!='Sea Fiction' and text[k+j][12:]!='Feminism') and (text[k+j][0:11]!='Sea Fiction' and text[k+j][12:]!='Politics') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Atomic warfare') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Homosexuality') and (text[k+j][0:7]!='Fiction' and text[k+j][8:]!='Atomic submarines') and (text[k+j][0:26]!='Swados, H. Story for Teddy' and text[k+j][-3:]!='and') and (text[k+j][0:11]!='Sea Fiction' and text[k+j][12:]!='Refugees') and (text[k+j][0:7]!='Germanv' and text[k+j][8:]!='Nasi movement') and (text[k+j][0:5]!='Papua' and text[k+j][6:]!='New Guinea'))):  # For wrong headings, ignore them; first character A-Z, second a-z (avoiding "BOOK REVIEW DIGEST"), last a-z or 0-9 (eg "Adams, Henry, 1838-1918")
                            if (len(text[
